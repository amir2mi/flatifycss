...
Three gorgeous dots, that is all a long document needs.
The opacity of the separators primarily are decreased, it helps element to tread more
as a passive object in the playground, you can use [opacity helper classes](/docs/helpers/opacity-setters) to change it.
