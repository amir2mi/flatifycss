...
`--flatify__input-bg-color`  
`--flatify__input-txt-color`  
`--flatify__input-border-color`  
`--flatify__input-border-color__focus`  
`--flatify__input-border-color__valid`  
`--flatify__input-border-color__warning`  
`--flatify__input-border-color__invalid`
...
<html lang="en">
	<head>
		...
		<style>
			:root{
				--flatify__input-bg-color: #FFCE54;
				--flatify__input-txt-color: #434A54;
				--flatify__input-border-color: #FFCE54;
				--flatify__input-border-color__focus: #F6BB42;
				--flatify__input-border-color__valid: #5D9CEC;
				--flatify__input-border-color__warning: #8067B7;
				--flatify__input-border-color__invalid: #BF263C;
			}
		</style>
	</head>
	<body>
