...
FlatifyCSS gives styles to the native `<select>` which can be denied by adding `.default` class Changing size and adding colors is similar to [inputs](/docs/forms/inputs).
