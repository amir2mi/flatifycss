...
It is possible to change radios appearance similar to buttons, it is a bit different from custom radios also it is necessary to [read about buttons](/docs/components/buttons), here is an example:
