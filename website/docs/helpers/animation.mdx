...
Before starting on, it is necessary to learn about CSS animations, [read more here](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Animations/Using_CSS_animations).
...
<html lang="en">
	...
	<body class="flex-center" style="flex-wrap: wrap">
		...
		<div class="my-box flex-center style-accent anim-hue"></div>
		<div class="my-box flex-center style-accent anim-hue-min"></div>
	</body>
</html>'
/>
