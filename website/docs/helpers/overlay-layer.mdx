...
<html lang="en">
	<head>
        ...
        <style>
			...
			.fx-6{
                --flatify__overlay-layer-bg-color: trasparent;
                --flatify__overlay-layer-opacity: 0.6;
                --flatify__overlay-layer-backdrop-filter: contrast(1000%) saturate(1000%) grayscale(50%) sepia(50%) hue-rotate(10deg);
            }
        </style>
    </head>
    <body>
...
.fx-2 {
	--flatify__overlay-layer-bg-color: linear-gradient(to right, #8e2de2, #4a00e0);
	--flatify__overlay-layer-blending-mode: diffrence;
}
.fx-3 {
	--flatify__overlay-layer-bg-color: linear-gradient(to right, #f12711, #f5af19);
	--flatify__overlay-layer-blending-mode: color-dodge;
	--flatify__overlay-layer-opacity: 0.5;
}
.fx-4 {
	--flatify__overlay-layer-bg-color: #212121;
	--flatify__overlay-layer-opacity: 0.6;
	--flatify__overlay-layer-backdrop-filter: blur(10px);
}
.fx-5 {
	--flatify__overlay-layer-bg-color: trasparent;
	--flatify__overlay-layer-opacity: 0.6;
	--flatify__overlay-layer-backdrop-filter: saturation(500%) contrast(500%) grayscale(100%);
}
```
