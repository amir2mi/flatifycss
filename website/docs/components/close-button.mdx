...
:::info
You do not need to add anything inside close button element but it is necessary to set `aria-label` HTML attribute accessibility purposes. [Read more about aria-label usage](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/ARIA_Techniques/Using_the_aria-label_attribute).
:::
