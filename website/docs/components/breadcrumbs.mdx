	...
	<body class="flex-column-center">
        <nav class="breadcrumbs-wrapper" aria-label="It is a breadcrumbs">
			<ol class="breadcrumbs">
				...
				<li class="crumb"><a href="#">Videos</a></li>
				<li class="crumb active" aria-current="location">How to become a web developer in one week and create awesome websites with no pain?</li>
			</ol>
		</nav>
	</body>
</html>
...
<html lang="en">
	...
	<body class="flex-column-center">
        <nav class="breadcrumbs-wrapper" aria-label="It is a breadcrumbs">
			<ol class="breadcrumbs style-dark">
				<li class="crumb"><a href="#">Home</a></li>
				<li class="crumb"><a href="#">Tutorials</a></li>
				<li class="crumb"><a href="#">Videos</a></li>
				<li class="crumb active" aria-current="location">How to create videos</li>
        ...
        <nav class="breadcrumbs-wrapper" aria-label="It is a breadcrumbs">
			<ol class="breadcrumbs style-blue">
				<li class="crumb"><a href="#">Home</a></li>
				<li class="crumb"><a href="#">Tutorials</a></li>
				<li class="crumb"><a href="#">Videos</a></li>
				<li class="crumb active" aria-current="location">How to create videos</li>
        ...
        <nav class="breadcrumbs-wrapper" aria-label="It is a breadcrumbs">
			<ol class="breadcrumbs style-orange">
				<li class="crumb"><a href="#">Home</a></li>
				<li class="crumb"><a href="#">Tutorials</a></li>
				<li class="crumb"><a href="#">Videos</a></li>
				<li class="crumb active" aria-current="location">How to create videos</li>
           ...
           <nav class="breadcrumbs-wrapper" aria-label="It is a breadcrumbs">
			<ol class="breadcrumbs style-yellow">
				<li class="crumb"><a href="#">Home</a></li>
				<li class="crumb"><a href="#">Tutorials</a></li>
				<li class="crumb"><a href="#">Videos</a></li>
				<li class="crumb active" aria-current="location">How to create videos</li>
