...
You can customize dropdowns, they offer you CSS variables to change, as you might be noticed a typical dropdown uses menu items, so to customize them check [menu component documentation](/docs/components/menu).
These are dropdowns CSS variables:

`--flatify__dropdown-bg-color`  
`--flatify__dropdown-txt-color`  
`--flatify__dropdown-border-color`

`--flatify__dropdown-show-animation-duration`  
`--flatify__dropdown-hide-animation-duration`
...
<html lang="en">
	<head>
		...
		<style>
    		...
    		.my-custom-dropdown{
				/* dropdown */
				--flatify__dropdown-bg-color: #D8334A;
    			--flatify__dropdown-txt-color: #F5F7FA;
    			--flatify__dropdown-border-color: #BF263C;
				...
				/* menu items */
				--flatify__menu-item-bg-color__hover: #A0D468;
				--flatify__menu-item-bg-color__active: #FFCE54;
				--flatify__menu-item-bg-color__focus: #F6BB42;
				--flatify__menu-item-txt-color__hover: #3C3B3D;
				--flatify__menu-item-txt-color__active: #BF263C;
				--flatify__menu-item-txt-color__focus: #BF263C;
			}
    	</style>
    	<script src="https://unpkg.com/@popperjs/core@2"></script>
    	<script src="https://raw.githack.com/amir2mi/flatifycss/master/dist/js/flatify-min.js"></script>
