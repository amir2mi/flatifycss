			...
			<div class="dropdown-wrapper">
				...
				>
					<li class="position-absolute place-top place-right">
						<button class="close-dropdown 	close-button size-xs" style="margin: 1.2em 0.64em" aria-label="Close dropdown"></button>
					</li>
					<li class="menu-item heading">My Account</li>
					<li class="menu-item"><a>Sign up</a></li>
					<li class="menu-item"><a>Login</a></li>
...
This is common for dropdowns to be opened by an arrow button that is stuck with a button, they are called split buttons. It is simply doable with [buttons](/docs/components/button) and [button group](/docs/components/button-group).
