...
FlatifyCSS is the web modern and minimalist flat design library, inspired by [Duolingo](https://www.duolingo.com/) design system. It respects accessibility and comes with the web's most common components.
